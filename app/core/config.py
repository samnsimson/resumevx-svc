...
class Settings(BaseSettings):
    ...
    inngest_dev: Optional[int] = Field(default=1, env="INNGEST_DEV")
    ...
    nebius_extraction_model: Optional[str] = Field(default=None, env="NEBIUS_EXTRACTION_MODEL")
    nebius_rewrite_model: Optional[str] = Field(default=None, env="NEBIUS_REWRITE_MODEL")
